...
type IconComponent = React.ComponentType<{ size?: number } & React.ComponentProps<'svg'>>;

const InstagramIcon: IconComponent = ({ size = 16, ...rest }) => {
  return (
    <svg
...
const TwitterIcon: IconComponent = ({ size = 16, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
const GithubIcon: IconComponent = ({ size = 16, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
const LinkedInIcon: IconComponent = ({ size = 16, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
...
const EmailIcon: IconComponent = ({ size = 16, ...rest }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="currentColor"
